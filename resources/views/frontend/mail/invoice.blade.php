...
<html lang="en">
  ...
  <body>
    @php
        $order = App\Models\Order::where('order_id', $order_id)->get()->first();
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="unit">&#2547; {{ $orderproduct->Product->Inventory->where('color_id', $orderproduct->color_id)->where('size_id', $orderproduct->size_id)->first()->after_discount }}</td>
                <td class="qty">{{ $orderproduct->quantity }}</td>
                <td class="total">&#2547; {{ $orderproduct->Product->Inventory->where('color_id', $orderproduct->color_id)->where('size_id', $orderproduct->size_id)->first()->after_discount * $orderproduct->quantity }}</td>
            </tr>
          @endforeach
        </tbody>
        <tfoot>
